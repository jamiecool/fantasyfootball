...
STAGES = [
    ...
    ("fetch_nflverse_team.py", "team-week stats + games -> D/ST game logs", False,
     "rawdata/nflverse/stats_team_week_2025.csv"),
    ...
    ("build_ppp_vor_board.py", "2nd league value pivot -> analysis/ppp_vor_board.csv", False, None),
